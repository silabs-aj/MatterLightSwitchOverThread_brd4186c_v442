...
// The names of clusters that are not present, are removed.
    ...
    #define CHIP_PRINTCLUSTER_ON_OFF_SWITCH_CONFIGURATION_CLUSTER { chip::app::Clusters::OnOffSwitchConfiguration::Id, "On/off Switch Configuration" },
#else
    ...
    #define CHIP_PRINTCLUSTER_OTA_SOFTWARE_UPDATE_PROVIDER_CLUSTER { chip::app::Clusters::OtaSoftwareUpdateProvider::Id, "OTA Software Update Provider" },
#else
    ...
    #define CHIP_PRINTCLUSTER_OTA_SOFTWARE_UPDATE_REQUESTOR_CLUSTER { chip::app::Clusters::OtaSoftwareUpdateRequestor::Id, "OTA Software Update Requestor" },
#else
    ...
    #define CHIP_PRINTCLUSTER_LOCALIZATION_CONFIGURATION_CLUSTER { chip::app::Clusters::LocalizationConfiguration::Id, "Localization Configuration" },
#else
    ...
    #define CHIP_PRINTCLUSTER_TIME_FORMAT_LOCALIZATION_CLUSTER { chip::app::Clusters::TimeFormatLocalization::Id, "Time Format Localization" },
#else
    ...
    #define CHIP_PRINTCLUSTER_POWER_SOURCE_CONFIGURATION_CLUSTER { chip::app::Clusters::PowerSourceConfiguration::Id, "Power Source Configuration" },
#else
    ...
    #define CHIP_PRINTCLUSTER_THREAD_NETWORK_DIAGNOSTICS_CLUSTER { chip::app::Clusters::ThreadNetworkDiagnostics::Id, "Thread Network Diagnostics" },
#else
    ...
    #define CHIP_PRINTCLUSTER_WIFI_NETWORK_DIAGNOSTICS_CLUSTER { chip::app::Clusters::WiFiNetworkDiagnostics::Id, "WiFi Network Diagnostics" },
#else
    ...
    #define CHIP_PRINTCLUSTER_ETHERNET_NETWORK_DIAGNOSTICS_CLUSTER { chip::app::Clusters::EthernetNetworkDiagnostics::Id, "Ethernet Network Diagnostics" },
#else
...
#if defined(ZCL_USING_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER_SERVER) || defined(ZCL_USING_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER { chip::app::Clusters::BridgedDeviceBasicInformation::Id, "Bridged Device Basic Information" },
#else
    ...
    #define CHIP_PRINTCLUSTER_ADMINISTRATOR_COMMISSIONING_CLUSTER { chip::app::Clusters::AdministratorCommissioning::Id, "Administrator Commissioning" },
#else
    ...
    #define CHIP_PRINTCLUSTER_OPERATIONAL_CREDENTIALS_CLUSTER { chip::app::Clusters::OperationalCredentials::Id, "Operational Credentials" },
#else
...
#if defined(ZCL_USING_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_CLUSTER_SERVER) || defined(ZCL_USING_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_CLUSTER { chip::app::Clusters::RefrigeratorAndTemperatureControlledCabinetMode::Id, "Refrigerator And Temperature Controlled Cabinet Mode" },
#else
    ...
    #define CHIP_PRINTCLUSTER_LAUNDRY_WASHER_CONTROLS_CLUSTER { chip::app::Clusters::LaundryWasherControls::Id, "Laundry Washer Controls" },
#else
    ...
    #define CHIP_PRINTCLUSTER_HEPA_FILTER_MONITORING_CLUSTER { chip::app::Clusters::HepaFilterMonitoring::Id, "HEPA Filter Monitoring" },
#else
    #define CHIP_PRINTCLUSTER_HEPA_FILTER_MONITORING_CLUSTER
#endif

#if defined(ZCL_USING_ACTIVATED_CARBON_FILTER_MONITORING_CLUSTER_SERVER) || defined(ZCL_USING_ACTIVATED_CARBON_FILTER_MONITORING_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_ACTIVATED_CARBON_FILTER_MONITORING_CLUSTER { chip::app::Clusters::ActivatedCarbonFilterMonitoring::Id, "Activated Carbon Filter Monitoring" },
#else
...
#if defined(ZCL_USING_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_SERVER) || defined(ZCL_USING_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER { chip::app::Clusters::PumpConfigurationAndControl::Id, "Pump Configuration and Control" },
#else
...
#if defined(ZCL_USING_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER_SERVER) || defined(ZCL_USING_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_THERMOSTAT_USER_INTERFACE_CONFIGURATION_CLUSTER { chip::app::Clusters::ThermostatUserInterfaceConfiguration::Id, "Thermostat User Interface Configuration" },
#else
    ...
    #define CHIP_PRINTCLUSTER_ILLUMINANCE_MEASUREMENT_CLUSTER { chip::app::Clusters::IlluminanceMeasurement::Id, "Illuminance Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_TEMPERATURE_MEASUREMENT_CLUSTER { chip::app::Clusters::TemperatureMeasurement::Id, "Temperature Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER { chip::app::Clusters::RelativeHumidityMeasurement::Id, "Relative Humidity Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_CARBON_MONOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::CarbonMonoxideConcentrationMeasurement::Id, "Carbon Monoxide Concentration Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_CARBON_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::CarbonDioxideConcentrationMeasurement::Id, "Carbon Dioxide Concentration Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_NITROGEN_DIOXIDE_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::NitrogenDioxideConcentrationMeasurement::Id, "Nitrogen Dioxide Concentration Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_OZONE_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::OzoneConcentrationMeasurement::Id, "Ozone Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_OZONE_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::Pm25ConcentrationMeasurement::Id, "PM2.5 Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_PM2_5_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::FormaldehydeConcentrationMeasurement::Id, "Formaldehyde Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_FORMALDEHYDE_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_PM1_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_PM1_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_PM1_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::Pm1ConcentrationMeasurement::Id, "PM1 Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_PM1_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_PM10_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_PM10_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_PM10_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::Pm10ConcentrationMeasurement::Id, "PM10 Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_PM10_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::TotalVolatileOrganicCompoundsConcentrationMeasurement::Id, "Total Volatile Organic Compounds Concentration Measurement" },
#else
    #define CHIP_PRINTCLUSTER_TVOC_CONCENTRATION_MEASUREMENT_CLUSTER
#endif

#if defined(ZCL_USING_RADON_CONCENTRATION_MEASUREMENT_CLUSTER_SERVER) || defined(ZCL_USING_RADON_CONCENTRATION_MEASUREMENT_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_RADON_CONCENTRATION_MEASUREMENT_CLUSTER { chip::app::Clusters::RadonConcentrationMeasurement::Id, "Radon Concentration Measurement" },
#else
    ...
    #define CHIP_PRINTCLUSTER_ELECTRICAL_MEASUREMENT_CLUSTER { chip::app::Clusters::ElectricalMeasurement::Id, "Electrical Measurement" },
#else

...
if (__context_tag == to_underlying(Fields::kAttributeValue))
        {
...
if (__context_tag == to_underlying(Fields::kMaxNumberOfIntervals))
        {
            err = DataModel::Decode(reader, maxNumberOfIntervals);
        }
        else
if (__context_tag == to_underlying(Fields::kListOfAttributes))
        {
...
if (__context_tag == to_underlying(Fields::kNumberOfIntervalsDelivered))
        {
...
if (__context_tag == to_underlying(Fields::kIntervals))
        {
...
if (__context_tag == to_underlying(Fields::kNumberOfIntervals))
        {

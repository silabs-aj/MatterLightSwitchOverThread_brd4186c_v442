...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000001, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* ActiveCalendarType */  \
...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000000, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* IdleModeInterval */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000001, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* ActiveModeInterval */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 23, 246 }, \
  { ZAP_CLUSTER_INDEX(23), 8, 26 }, \
  { ZAP_CLUSTER_INDEX(31), 3, 21 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x00000103,1},{0x0000000F,1}}
